 ...
 */
 ...
 const Background = () => {
  ...
  return (
    <div className={location.pathname !== "/notadipdata" && location.pathname !== "/listaclientidip" && location.pathname !== "/stampamassiva" && location.pathname !== "/notadip" && location.pathname !== "/scalettadatadip" ? "background-imagePage" : ""}></div>
